...
class ValesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'correlativo_inicial.lte' => 'El correlativo inicial debe ser menor o igual que el correlativo final.',
            'correlativo_final.gte' => 'El correlativo final debe ser mayor o igual que el correlativo inicial.',
